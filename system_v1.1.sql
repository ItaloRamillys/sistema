...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Ago-2020 às 01:02
...
INSERT INTO `recurrence_lesson` (`id_rec_lesson`, `id_subject`, `id_class`, `day_of_week`, `order_lesson`, `id_teacher`, `year`) VALUES
(17, 3, 11, 5, 2, 8, 2020),
(18, 1, 25, 5, 3, 133, 2020);
...
(5, 'Cesar', 'Ramillys', 'csa', '123', 'i2taloramillys@gmail.com', '12/04/1999', '', '', '13424', '', '', NULL, 0, 1, '2020-02-01 00:00:00', '2020-08-01 14:00:22', 1, 1),
...
(38, 'Ester Lopes', 'Silva', 'ester', '123', 'ester@gmail.com', '12/04/1999', '', '', '524352435', '4325423523', '', 'usuario/2020/08/FLA-20200809145330-2fbc1830.jpg', 0, 1, '2020-02-01 00:00:00', '2020-08-09 09:53:30', 1, 38),
...
(133, 'Albert', 'Dutra', 'albert_dutra', '123', 'dutra@gmail.com', '01/12/1999', 'A+', 'M', '8702935', '98723587', 'Fortaleza - Pici', 'usuario/2020/07/FLA-20200724202038-61374aec.jpg', 1, 1, '2020-02-07 00:00:00', '2020-08-03 08:30:26', 1, 133),
(191, 'Lavinia', 'Lopes', 'lavinia', '123', 'iv0ina@gmail.com', '09/12/1999', 'A+', 'm', '87235', '897235', 'Fortaleza - SC', NULL, 1, 1, '2020-02-07 00:00:00', '2020-08-01 14:01:15', 1, 1),
...
(277, 'Sandra', 'Benicio', 'sandrinha', '1234567890', 'sandra@gmail.com', '16/11/1966', 'A+', 'F', '', '953.996.903-49', 'Pindoretama', NULL, 2, 1, '2020-07-08 00:00:00', '2020-08-08 09:42:24', 1, 0),
(282, 'Suriel', 'Ports', 'suriel', 'portstrader', 'surielports@gmail.com', '07/02/1992', 'a+', 'M', '', '091.782.341-20', 'Campinas', 'usuario/2020/08/dev.jpg', 2, 1, '2020-08-02 14:57:59', '2020-08-08 09:43:00', 1, NULL),
(283, 'Ubirtan', 'Junior', 'ubirapenis', 'bira1234567890', 'ubiratanj@gmail.com', '05/06/1999', 'a+', 'M', '', '809.128.341-09', 'Itapipoca', 'usuario/2020/08/FLA.jpg', 0, 1, '2020-08-02 15:01:38', NULL, 1, NULL);
...
--
ALTER TABLE `class_student`
  MODIFY `id_CS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `recurrence_lesson`
  MODIFY `id_rec_lesson` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
ALTER TABLE `recurrence_lesson`
  ...
  ADD CONSTRAINT `fk_teacher` FOREIGN KEY (`id_teacher`) REFERENCES `user` (`id`);
COMMIT;
