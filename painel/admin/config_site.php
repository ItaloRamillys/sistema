...
?>
    ...
    <div class="box col-12 p-0">
      ...
      <div class="div-content-box">
        <form class="form-cad row" id="form" method="POST" enctype="multipart/form-data">
            ...
            <article>
              <ul>
                ...
                <li style="display: flex; justify-content: space-around;">
                    ...
                    <img src="<?php echo $img1;  ?>" id="img1" width="160px" height="160px" >
                    <img src="<?php echo $img2;  ?>" id="img2" width="160px" height="160px" >
                    <img src="<?php echo $img3;  ?>" id="img3" width="160px" height="160px" >
