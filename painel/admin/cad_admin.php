                  ...
                  <article>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-sm-6">
                          ...
                          <li><input type="text" name="data_nasc" class="date" data-mask="00/00/0000" placeholder="Ex.: 12/05/2000" required></li>

                          <li><label>CPF</label></li>
                          <li><input type="text" name="cpf" class="cpf" data-mask="000.000.000-00"  placeholder="CPF"></li>
