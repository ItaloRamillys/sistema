            ...
            <div class="box"> 
                ...
                if ($stmt->rowCount() > 0) {
                    $res = "<section>";
                        ...
                        $res .= "<table id='table-scroll' class='table table-hover'><thead><tr><th>Imagem</th><th class='text-center'>Nomw completo</th><th class='text-center'>Email</th><th class='text-center'>Status</th><th class='text-center'>Ações</th></tr></thead><tbody>";
