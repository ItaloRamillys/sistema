<?php
$year = date("Y");
$query_class_teacher = "select s.name_subject, y.name_class from subject s inner join(select c.name_class, x.id_subject from class c inner join(SELECT sc.id_class, sc.id_subject FROM `subject_class` sc where 
